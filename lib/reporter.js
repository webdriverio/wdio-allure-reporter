...
class AllureReporter extends events.EventEmitter {
    constructor (baseReporter, config, options = {}) {
        ...
        this.on('runner:screenshot', this.runnerScreenshot)
        this.on('end', () => {
    ...
    bindEventFunctions () {
        ...
        this.runnerCommand = this.runnerCommand.bind(this)
        this.runnerResult = this.runnerResult.bind(this)
        this.runnerScreenshot = this.runnerScreenshot.bind(this)

        this.allureFeature = this.allureFeature.bind(this)
        this.allureAddEnvironment = this.allureAddEnvironment.bind(this)
        this.allureAttachment = this.allureAttachment.bind(this)
        this.allureStory = this.allureStory.bind(this)
    }
